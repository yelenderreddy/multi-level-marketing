...
export const productStatusEnum = pgEnum("product_status", ["AVAILABLE", "OUT_OF_STOCK", "DISCONTINUED"]);
...
export const products = pgTable("products", {
  ...
  productStatus: productStatusEnum("productStatus").notNull().default("AVAILABLE"),
